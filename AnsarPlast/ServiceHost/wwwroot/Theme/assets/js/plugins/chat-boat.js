...
/*--------------------- Start Chat Boat ---------------------- */
   ...
   var kid = {
    ...
    $('.ec-float-chat').on('click', function(){
        ...
        var isClass = $('.ec-chat').hasClass('animate__fadeOutLeft');
        if(isClass){
            $('.ec-chat').removeClass('animate__fadeOutLeft');	
            $('.ec-chat').addClass('animate__fadeInLeft');	
        } else {
            $('.ec-chat').removeClass('animate__fadeInLeft');	
            $('.ec-chat').addClass('animate__fadeOutLeft');
        }	
    });	
