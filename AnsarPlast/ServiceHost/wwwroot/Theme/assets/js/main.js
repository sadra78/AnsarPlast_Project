...
function ecCheckCookie() {
    ...
    if (bgImageMode != "") {
        ...
        $("#bg-switcher-css").attr("href", "~/Theme/assets/css/backgrounds/" + bgID + ".css");
    }
    ...
    if (darkMode != "") {
        var $link = $('<link>', {
            rel: 'stylesheet',
            href: '~/Theme/assets/css/dark.css',
            class: 'dark'
        });

        $("link[href='~/Theme/assets/css/responsive.css']").before($link);
        ...
        if (themeColor != "") {
            ...
            if (themeColor != '01') {
                $("link[href='~/Theme/assets/css/responsive.css']").before('<link rel="stylesheet" href="~/Theme/assets/css/skin-' + themeColor + '.css" rel="stylesheet">');
            }
        }
    }
}
...
(function ($) {
        ...
        setTimeout(function () {
            switch (window.location.protocol) {
                case 'file:':
                    ...
                    var alertBody = '<div id="ec-direct-run" class="ec-direct-run"><div class="ec-direct-body"><h4>قالب به صورت مستقیم لود شده است</h4><p>متوجه شدیم شما قالب را بدون استفاده از لوکال سرور بالا آورده اید. در این حالت به برخی ویژگی ها دسترسی ندارید. لطفا از لوکال سرور یا لایو سرور استفاده نمایید </p></div></div>';
    ...
    $(".ec-remove-wish").on("click", function () {
        ...
        if (wish_product_count == 0) {
            $('.ec-compare-rightside').html('<p class="emp-wishlist-msg">لیست علاقه مندی ها خالی است!</p>');
        }
    });
    ...
    (function () {
        ...
        $("body").on("click", ".ec-pro-content .remove", function () {
            ...
            if (cart_product_count == 1) {
                $('.eccart-pro-items').html('<li><p class="emp-cart-msg">سبد خرید شما خالی است!</p></li>');
            }
    ...
    $('.ec-change-color').on('click', 'li', function () {
        $('link[href^="~/Theme/assets/css/skin-"]').remove();
        $('link.dark').remove();
        ...
        if (dataValue != undefined) {
            $("link[href='~/Theme/assets/css/rtl.css']").before('<link rel="stylesheet" href="~/Theme/assets/css/skin-' + dataValue + '.css" rel="stylesheet">');
    ...
    $(document).ready(function () {
        $(".ec-more-toggle").click(function () {
            ...
            if (elem == "دسته‌بندی‌های بیشتر") {
                $(".ec-more-toggle #ec-more-toggle").text("دسته‌بندی‌های کمتر");
                $(".ec-more-toggle").toggleClass('active');
                $("#ec-more-toggle-content").slideDown();
            } else {

                $(".ec-more-toggle  #ec-more-toggle").text("دسته‌بندی‌های بیشتر");
    ...
    $(".ec-tools-sidebar-toggle").on("click", function (e) {
        e.preventDefault();
        if ($(this).hasClass("in-out")) {
            $(".ec-tools-sidebar").stop().animate({ left: "0px" }, 100);
            $(".ec-tools-sidebar-overlay").fadeIn();
            if ($(".ec-tools-sidebar-toggle").not("in-out")) {
                $(".ec-tools-sidebar").stop().animate({ left: "-200px" }, 100);
                $(".ec-tools-sidebar-toggle").addClass("in-out");
                // $(".ec-tools-sidebar-overlay").fadeOut();
            }
            if ($(".ec-tools-sidebar-toggle").not("in-out")) {
                $(".ec-tools-sidebar").stop().animate({ left: "0" }, 100);
                $(".ec-tools-sidebar-toggle").addClass("in-out");
                $(".ec-tools-sidebar-overlay").fadeIn();
            }
        } else {
